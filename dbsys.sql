...
INSERT INTO `carrera` (`idCarrera`, `carrera`, `abreviatura`) VALUES
(1, 'Licenciatura en Derecho', 'LDE'),
(2, 'Licenciatura en Diseño Industrial', 'LDI'),
(3, 'Licenciatura en Contaduria', 'LCO'),
(4, 'Licenciatura en Enfermeria', 'LEN'),
(5, 'Licenciatura en Informática Administrativa', 'LIA'),
(6, 'Licenciatura en Ingeniería en Computacion', 'ICO');
